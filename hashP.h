...
struct ht_hash {
	size_t (* ht_hash_f)(const void *key);
								/* hash function */
	int    (* ht_equals_f)(const void *key_a, const void *key_b);
								/* equals function */
	const void *(*ht_dup_f)(const void *key); /* duplicating key function */
	void (*ht_free_f)(const void *key); /* freeing memory function */
